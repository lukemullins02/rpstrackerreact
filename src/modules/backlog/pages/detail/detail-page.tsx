...
export function DetailPage() {
  ...
  const [selectedDetailsScreen, setSelectedDetailsScreen] =
    useState<DetailScreenType>(screen ? screen : "details");
  ...
  const updateTaskMutation = useMutation(
    async (taskUpdate: PtTaskTitleUpdate) => {
  ...
  const addCommentMutation = useMutation(
    async (newCommentItem: PtNewComment) => {
      const createdComment = await backlogService.addNewPtComment(
        newCommentItem,
        item!,
      );
