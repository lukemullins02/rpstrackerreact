...
export function PtItemDetailsComponent(props: PtItemDetailsComponentProps) {
  ...
  const [selectedAssignee, setSelectedAssignee] = useState<PtUser>(
    props.item.assignee,
  );
  useEffect(() => {
    notifyUpdateItem();
  ...
  function itemTypeRender(li: any, itemProps: ListItemProps) {
    ...
    <React.Fragment>
      <form>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <DropDownList
              ...
              itemRender={(li, props) => itemTypeRender(li, props)}
              defaultValue={itemForm.typeStr}
              onChange={(e) => onNonTextFieldChange(e, "typeStr")}
              name="itemType"
            ></DropDownList>
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <DropDownList
              ...
              onChange={(e) => onNonTextFieldChange(e, "statusStr")}
            ></DropDownList>
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <input
              ...
              onChange={(e) => onNonTextFieldChange(e, "estimate")}
              name="estimate"
              style={{ width: 300 }}
            />
          </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <DropDownList
              data={prioritiesProvider}
              itemRender={(li, props) => priorityRender(li, props)}
              defaultValue={itemForm.priorityStr}
              onChange={(e) => onNonTextFieldChange(e, "priorityStr")}
              name="priority"
            ></DropDownList>
          </div>
        </div>
